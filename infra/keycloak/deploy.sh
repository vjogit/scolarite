...
export TF_VAR_test_consultation_user_enabled="${TEST_CONSULTATION_USER_ENABLED:-false}"
export TF_VAR_test_consultation_user_username="${TEST_CONSULTATION_USER_USERNAME:-}"
export TF_VAR_test_consultation_user_email="${TEST_CONSULTATION_USER_EMAIL:-}"
export TF_VAR_test_consultation_user_password="${TEST_CONSULTATION_USER_PASSWORD:-}"
export TF_VAR_test_notes_ecriture_user_enabled="${TEST_NOTES_ECRITURE_USER_ENABLED:-false}"
