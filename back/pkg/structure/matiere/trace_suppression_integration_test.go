...
// Invariant 5, fermé le 17 septembre 2026 : supprimer la matière (deux contrôles, trois notes)
...
func TestIntegration_Delete_TraceLesNotesEmportees(t *testing.T) {
	...
	fixture := services.SeedStructureFixture(t, pool, "tr-matiere")
	...
	Delete(rec, services.NewBulkIDsRequest(t, pool, http.MethodDelete, "/bulk", []int32{fixture.MatiereID}))
