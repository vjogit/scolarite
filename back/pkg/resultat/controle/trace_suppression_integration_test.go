...
// Invariant 5, fermé le 17 septembre 2026 : supprimer le contrôle C1 (deux notes)
...
func TestIntegration_Delete_TraceLesNotesEmportees(t *testing.T) {
	...
	fixture := services.SeedStructureFixture(t, pool, "tr-controle")
	...
	Delete(rec, services.NewBulkIDsRequest(t, pool, http.MethodDelete, "/bulk", []int32{fixture.ControleID}))
	...
	assert.Equal(t, 2, apres-avant, "un maillon note.delete par note emportée")
	assert.Equal(t, 3-2, notesRestantes)
