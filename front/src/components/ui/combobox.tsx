...
function ComboboxTrigger({
  ...
  // Le nom accessible que le thème MUI (`composantsTraduits`) donnait au
  // bouton d'ouverture des Autocomplete est porté ici — l'état ouvert/fermé
  // est déjà dit par `aria-expanded`, que Base UI pose lui-même.
  const { t } = useTranslation("app")
  return (
    <ComboboxPrimitive.Trigger
      data-slot="combobox-trigger"
      aria-label={t("autocomplete.ouvrir")}
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  // Même transposition que le déclencheur : le `clearText` du thème MUI.
  const { t } = useTranslation("app")
  return (
    <ComboboxPrimitive.Clear
      data-slot="combobox-clear"
      aria-label={t("autocomplete.effacer")}
...
// `useComboboxAnchor` (un simple `useRef` d'ancre, pour les variantes à
// chips) n'est pas exporté : règle react-refresh, aucun consommateur — même
// motif que la séparation button/button-variants.
