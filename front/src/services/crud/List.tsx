/**
 * La liste : l'orchestration commune des écrans CRUD — requête, suppression,
 * droits, mise en évidence — branchée sur `DataTable` (TanStack Table rendu
 * en shadcn).
 *
 * Née `ListTanstack` au lot 7, à côté du commutateur qui servait encore
 * `ListMrt` aux écrans non migrés ; le lot 11 a déposé MRT, elle a repris le
 * nom et l'export de l'unique liste qu'elle est redevenue.
 */
